...
void TreeType::Anscestors(ItemType value, QueType& path) //출력용 파라미터를 참조형으로 하면 문제가 없다.
//즉, QueType같은 객체를 함수 내에서 작업하고 출력할 때. 
{
	/*
    ...
    */
    ...
    {
        cout << "Can't find value in tree, 출력된 숫자 의미 없음";
    }
