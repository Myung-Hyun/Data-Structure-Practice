...
{
  NodeType2<ItemType>* newNode;  // pointer to node being inserted
  NodeType2<ItemType>* predLoc;  // trailing pointer
  NodeType2<ItemType>* location; // traveling pointer
  bool moreToSearch;
  ...
  newNode = new NodeType2<ItemType>;
  newNode->info = item;
